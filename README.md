[![GoDoc](https://godoc.org/github.com/vedranvuk/go-xml?status.svg)](https://godoc.org/github.com/vedranvuk/go-xml) [![Build Status](https://travis-ci.org/droyo/go-xml.svg?branch=master)](https://travis-ci.org/droyo/go-xml)
...
```
go get github.com/vedranvuk/go-xml/...
```
